    ...
    public class CursoController : Controller//
    {
        ...
        public ActionResult Guardar(Curso model, int[] docente = null, string[] codigo_curso = null, string[] nuevo = null)
        {
            ...
            if (g.Equals("si"))
            {
                ...
                {
                    model.GuardarNuevo();
                    return Redirect("~/Backend/Curso/Index/" + model.plan_id);
                }
                else
                {
                    return View("~/Backend/Curso/Index/AgregarEditar.cshtml", model);
                }
            }
            else
            {
        ...
        public ActionResult Eliminar(string id)
        {
            curso.curso_cod = id;
            curso.Eliminar();
            return Redirect("~/BackEnd/Curso/Index/" + Session["plan_id"].ToString());
        }
